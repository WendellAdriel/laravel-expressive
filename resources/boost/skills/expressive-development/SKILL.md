...
Use this skill when a Laravel application needs a typed Data Mapper layer on top of Eloquent using Expressive.
...
- Artisan help in the consuming app: `php artisan help make:expressive` and `php artisan help expressive:sync`
